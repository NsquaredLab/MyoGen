"""
Descending drive neuron populations for cortical input - Jaxley Backend.
...
class DescendingDrive__Pool(_Pool):
    """
    Container for a population of descending drive neurons - Jaxley Backend.
...
class DescendingDrive_Gamma__Pool(_Pool):
    """
    Container for a population of descending drive neurons using Gamma process - Jaxley Backend.
